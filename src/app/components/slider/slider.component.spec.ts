...
describe('SliderComponent', () => {
  ...
  it('change the field value if input changes', () => {
    ...
    expect(hostComponent.sliderComponent.inputRange.value).toBe('11');
  });

  it('change the field value if input changes null', () => {
    hostComponent.sliderComponent.writeValue(null);
    hostComponent.sliderComponent.registerOnTouched(() => {});
    hostComponent.sliderComponent.registerOnChange(() => {});
    expect(hostComponent.sliderComponent.inputRange.value).toBe('0');
  });
